...
public class EnumSoundsWWCP {
    ...
    public static final SoundRecord locoDieselDSBMT = new SoundRecord(EntityDSBMT.class, "wwcp:DSBMH_Whistle", 0.8F, "wwcp:FM_38D_6_Notch8", 0.25F, 40, "wwcp:FM_38D_6_Idle", 0.15F, 40, true, " ", 0);
