...
import wwcp.client.render.rollingstock.locomotives.steamers.German.BR01.DB_BR01_Neubaukessel;
import wwcp.common.core.handler.Transport;

import java.util.ArrayList;

public class EntityDBBR01_neubaukessel extends SteamTrain {

    public EntityDBBR01_neubaukessel(World world) {
    ...
    public void onRenderInsertRecord() {
        Traincraft.traincraftRegistry.RegisterRollingStockModel(
                new TrainRenderRecord(wwcp.common.library.Info.modID,
                        EntityDBBR01_neubaukessel.class, new DB_BR01_Neubaukessel(),
                        "DBBR01",
                        ...
                        "explode", new ArrayList<double[]>() { { add(new double[] { 5.5D, -0.1875D, 0.6875D }); }}, 10, 2)
                {
                    ...
                    public ResourceLocation getTextureFile(String colorAsString) {
                        ...
                        switch (colorAsString.toLowerCase()) {
                            case "black":
                                texturePath = "textures/locomotive/Steam/BR01/DBBR01/BR01_Neubaukessel_1";
                                break;
                            case "red":
                                texturePath = "textures/locomotive/Steam/BR01/DBBR01/BR01_Neubaukessel_2";
                                break;
                            case "green":
                                texturePath = "textures/locomotive/Steam/BR01/DBBR01/BR01_Neubaukessel_3";
                                break;
                            case "brown":
                                texturePath = "textures/locomotive/Steam/BR01/DBBR01/BR01_Neubaukessel_4";
                                break;
                        }
                        texturePath += ".png";
