...
public class Entity1stClassRheingoldSalon extends AbstractPassengerCar {

    public Entity1stClassRheingoldSalon(World world) {
        super(world);
    ...
    public void onRenderInsertRecord() {
        Traincraft.traincraftRegistry.RegisterRollingStockModel(
                new TrainRenderRecord(wwcp.common.library.Info.modID,
                        Entity1stClassRheingoldSalon.class, new Rheingold19281Salon(),
                        "RheingoldSalon1",
                    ...
                    public ResourceLocation getTextureFile(String colorAsString) {
                        ...
                        switch (colorAsString.toLowerCase()) {
                            case "yellow":
                                texturePath = "textures/passengerstock/RheingoldSet/Salon1";
                                break;
                        }
                        texturePath += ".png";
