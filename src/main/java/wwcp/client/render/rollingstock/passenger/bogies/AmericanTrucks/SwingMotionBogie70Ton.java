...
package wwcp.client.render.rollingstock.passenger.bogies.AmericanTrucks; //Path where the model is located


import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class SwingMotionBogie70Ton extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
