...
package wwcp.client.render.rollingstock.passenger.locomotives.electrics; //Path where the model is located
...
public class F140MS2 extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[378] = new ModelRendererTurbo(this, 505, 33, textureX, textureY, BoxName.lamp); // Backlamp
		...
		bodyModel[421] = new ModelRendererTurbo(this, 505, 33, textureX, textureY,BoxName.lamp); // Backlamp
		bodyModel[422] = new ModelRendererTurbo(this, 505, 33, textureX, textureY, BoxName.lamp); // FrontLamp
