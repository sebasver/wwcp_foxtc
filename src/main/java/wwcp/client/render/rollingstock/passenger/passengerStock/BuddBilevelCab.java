...
package wwcp.client.render.rollingstock.passenger.passengerStock; //Path where the model is located


import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class BuddBilevelCab extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
