...
package wwcp.client.render.rollingstock.passenger.locomotives.steamers.GermanBR.BR50.DRG; //Path where the model is located

import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class DRG_BR_50_Kriegslok extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
