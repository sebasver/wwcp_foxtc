...
package wwcp.client.render.rollingstock.passenger.railbusses; //Path where the model is located

import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class TEEBarWagon extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
