...
package wwcp.client.render.rollingstock.passenger.bogies; //Path where the model is located

import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class Class76BogieTurned extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
