...
package wwcp.client.render.rollingstock.passenger.passengerStock.Rheingold; //Path where the model is located


import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class RheingoldSalonOne extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
