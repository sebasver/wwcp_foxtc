...
package wwcp.client.render.rollingstock.passenger.passengerStock.Eurofima; //Path where the model is located

import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class EurofimaFlatConstruction extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
