...
package wwcp.client.render.rollingstock.passenger.tenders; //Path where the model is located
...
public class ChristmasTenderT32 extends ModelConverter //Same as Filename
{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[27] = new ModelRendererTurbo(this, 425, 1, textureX, textureY, BoxName.lamp); // Backlamp
		...
		bodyModel[31] = new ModelRendererTurbo(this, 449, 1, textureX, textureY, BoxName.lamp); // Backlamp
