...
package wwcp.client.render.rollingstock.passenger.bogies.TenderBogies; //Path where the model is located


import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class Tender32Bogie extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
