...
package wwcp.client.render.rollingstock.passenger.TCTemp; //Path where the model is located


import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class PropagandaCar extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 256;
