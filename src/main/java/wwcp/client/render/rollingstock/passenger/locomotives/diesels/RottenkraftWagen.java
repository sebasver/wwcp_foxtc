...
package wwcp.client.render.rollingstock.passenger.locomotives.diesels; //Path where the model is located

import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class RottenkraftWagen extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
