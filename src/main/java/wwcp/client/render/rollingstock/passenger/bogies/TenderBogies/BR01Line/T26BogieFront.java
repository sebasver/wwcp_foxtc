...
package wwcp.client.render.rollingstock.passenger.bogies.TenderBogies.BR01Line; //Path where the model is located

import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class T26BogieFront extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 128;
