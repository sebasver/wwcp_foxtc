...
package wwcp.client.render.rollingstock.passenger.tenders.germanTenders; //Path where the model is located


import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class KabintenderT26 extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
