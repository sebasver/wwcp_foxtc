...
package wwcp.client.render.rollingstock.passengerStock; //Path where the model is located

import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class ClassDonder3 extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
