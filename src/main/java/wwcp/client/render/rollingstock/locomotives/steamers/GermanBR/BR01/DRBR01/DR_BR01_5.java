...
package wwcp.client.render.rollingstock.locomotives.steamers.GermanBR.BR01.DRBR01; //Path where the model is located

import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class DR_BR01_5 extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
