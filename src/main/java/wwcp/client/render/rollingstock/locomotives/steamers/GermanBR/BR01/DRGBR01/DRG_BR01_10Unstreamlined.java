...
package wwcp.client.render.rollingstock.locomotives.steamers.GermanBR.BR01.DRGBR01; //Path where the model is located

import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class DRG_BR01_10Unstreamlined extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
