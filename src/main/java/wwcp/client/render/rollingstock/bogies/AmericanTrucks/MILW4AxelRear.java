...
public class MILW4AxelRear extends ModelConverter
{
	int textureX = 512;
	int textureY = 512;

	public MILW4AxelRear() //Same as Filename
	{
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[193] = new ModelRendererTurbo(this, 97, 25, textureX, textureY); // Box 193
		bodyModel[194] = new ModelRendererTurbo(this, 105, 33, textureX, textureY); // Box 194
		...
		bodyModel[2].setRotationPoint(8.5F, 3F, -10F);
		...
		bodyModel[3].setRotationPoint(11F, 2.25F, 7F);

		bodyModel[4].addBox(0F, 0F, 0F, 57, 1, 2, 0F); // Box 592
		bodyModel[4].setRotationPoint(-43.5F, 1.25F, 7F);

		bodyModel[5].addBox(0F, 0F, 0F, 6, 1, 2, 0F); // Box 593
		bodyModel[5].setRotationPoint(6.5F, 6.25F, 7F);
		...
		bodyModel[6].setRotationPoint(7F, 2.25F, 7F);

		bodyModel[7].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F,0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F); // Box 595
		bodyModel[7].setRotationPoint(12.25F, 5.25F, 7F);

		bodyModel[8].addShapeBox(0F, 0F, 0F, 14, 1, 2, 0F,0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F); // Box 596
		bodyModel[8].setRotationPoint(-7.25F, 5.25F, 7F);
		...
		bodyModel[10].setRotationPoint(-11.5F, 3F, -10F);
		...
		bodyModel[13].setRotationPoint(-27.5F, 3F, -10F);
		...
		bodyModel[15].setRotationPoint(-9F, 2.25F, 7F);

		bodyModel[16].addBox(0F, 0F, 0F, 6, 1, 2, 0F); // Box 605
		bodyModel[16].setRotationPoint(-13.5F, 6.25F, 7F);
		...
		bodyModel[17].setRotationPoint(-13F, 2.25F, 7F);
		...
		bodyModel[18].setRotationPoint(-25F, 2.25F, 7F);

		bodyModel[19].addBox(0F, 0F, 0F, 6, 1, 2, 0F); // Box 609
		bodyModel[19].setRotationPoint(-29.5F, 6.25F, 7F);
		...
		bodyModel[20].setRotationPoint(-29F, 2.25F, 7F);

		bodyModel[21].addShapeBox(0F, 0F, 0F, 10, 1, 2, 0F,0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F); // Box 611
		bodyModel[21].setRotationPoint(-23.25F, 5.25F, 7F);

		bodyModel[22].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 614
		bodyModel[22].setRotationPoint(9F, -1.75F, 7F);

		bodyModel[23].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 615
		bodyModel[23].setRotationPoint(10F, -1.75F, 7F);
		...
		bodyModel[24].setRotationPoint(14F, -1.75F, 8.25F);

		bodyModel[25].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F); // Box 617
		bodyModel[25].setRotationPoint(5F, -1.75F, 7F);
		...
		bodyModel[26].setRotationPoint(5F, -1.75F, 8.25F);

		bodyModel[27].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 619
		bodyModel[27].setRotationPoint(-10F, -1.75F, 7F);

		bodyModel[28].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 620
		bodyModel[28].setRotationPoint(-11F, -1.75F, 7F);

		bodyModel[29].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F); // Box 621
		bodyModel[29].setRotationPoint(-15F, -1.75F, 7F);
		...
		bodyModel[30].setRotationPoint(-6F, -1.75F, 8.25F);
		...
		bodyModel[31].setRotationPoint(-15F, -1.75F, 8.25F);
		...
		bodyModel[32].setRotationPoint(-31F, -1.25F, 8.25F);

		bodyModel[33].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F); // Box 625
		bodyModel[33].setRotationPoint(-31F, -1.75F, 7F);

		bodyModel[34].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 626
		bodyModel[34].setRotationPoint(-27F, -1.75F, 7F);

		bodyModel[35].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 627
		bodyModel[35].setRotationPoint(-26F, -1.75F, 7F);
		...
		bodyModel[36].setRotationPoint(-22F, -1.75F, 8.25F);
		...
		bodyModel[37].setRotationPoint(-19F, 3.25F, 7F);

		bodyModel[38].addShapeBox(0F, 0F, 0F, 3, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F); // Box 630
		bodyModel[38].setRotationPoint(-22F, 2.75F, 7F);

		bodyModel[39].addShapeBox(0F, 0F, 0F, 3, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 631
		bodyModel[39].setRotationPoint(-18F, 2.75F, 7F);
		...
		bodyModel[40].setRotationPoint(-19F, 1.75F, 7F);

		bodyModel[41].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F); // Box 633
		bodyModel[41].setRotationPoint(-6F, 7.25F, 7F);

		bodyModel[42].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 634
		bodyModel[42].setRotationPoint(1F, 7.25F, 7F);

		bodyModel[43].addBox(0F, 0F, 0F, 3, 2, 2, 0F); // Box 635
		bodyModel[43].setRotationPoint(-2F, 7.25F, 7F);
		...
		bodyModel[44].setRotationPoint(-2F, 6.25F, 7F);

		bodyModel[45].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F,0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 637
		bodyModel[45].setRotationPoint(13.5F, 2.25F, 7F);
		...
		bodyModel[46].setRotationPoint(-20F, -0.25F, 7F);

		bodyModel[47].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 639
		bodyModel[47].setRotationPoint(-3F, 2.25F, 7F);

		bodyModel[48].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 640
		bodyModel[48].setRotationPoint(2F, 2.25F, 7F);

		bodyModel[49].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 641
		bodyModel[49].setRotationPoint(-2F, 3.25F, 7F);

		bodyModel[50].addBox(0F, 0F, 0F, 4, 2, 1, 0F); // Box 642
		bodyModel[50].setRotationPoint(-2F, 2.75F, 8F);

		bodyModel[51].addShapeBox(0F, 0F, 0F, 8, 1, 2, 0F,0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F); // Box 643
		bodyModel[51].setRotationPoint(-37.25F, 5.25F, 7F);

		bodyModel[52].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 644
		bodyModel[52].setRotationPoint(-34.5F, 2.25F, 7F);

		bodyModel[53].addShapeBox(0F, 0F, 0F, 4, 1, 2, 0F,0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F); // Box 645
		bodyModel[53].setRotationPoint(13.5F, 1.25F, 7F);

		bodyModel[54].addShapeBox(0F, 0F, 0F, 4, 1, 2, 0F,0F, 0F, 0F, 0F, 1.5F, 0F, 0F, 1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 646
		bodyModel[54].setRotationPoint(13.5F, 5.25F, 7F);

		bodyModel[55].addShapeBox(0F, 0F, 0F, 1, 4, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0.5F, 0F); // Box 647
		bodyModel[55].setRotationPoint(17.5F, 0.25F, 7F);

		bodyModel[56].addBox(0F, 0F, 0F, 17, 3, 1, 0F); // Box 648
		bodyModel[56].setRotationPoint(18.5F, 0.25F, 8F);

		bodyModel[57].addShapeBox(0F, 0F, 0F, 8, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0.25F, 0F); // Box 650
		bodyModel[57].setRotationPoint(18.5F, 3.25F, 8F);

		bodyModel[58].addShapeBox(0F, 0F, 0F, 1, 2, 18, 0F,0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F); // Box 651
		bodyModel[58].setRotationPoint(39.5F, 1.25F, -9F);

		bodyModel[59].addShapeBox(0F, 0F, 0F, 8, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0.25F, 0F); // Box 653
		bodyModel[59].setRotationPoint(18.5F, 3.25F, -9F);

		bodyModel[60].addShapeBox(0F, 0F, 0F, 4, 1, 2, 0F,0F, 0F, 0F, 0F, 1.5F, 0F, 0F, 1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 654
		bodyModel[60].setRotationPoint(13.5F, 5.25F, -9F);

		bodyModel[61].addShapeBox(0F, 0F, 0F, 4, 1, 2, 0F,0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F); // Box 655
		bodyModel[61].setRotationPoint(13.5F, 1.25F, -9F);
		...
		bodyModel[62].setRotationPoint(11F, 2.25F, -9F);

		bodyModel[63].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F,0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F); // Box 657
		bodyModel[63].setRotationPoint(12.25F, 5.25F, -9F);

		bodyModel[64].addBox(0F, 0F, 0F, 57, 1, 2, 0F); // Box 658
		bodyModel[64].setRotationPoint(-43.5F, 1.25F, -9F);

		bodyModel[65].addBox(0F, 0F, 0F, 17, 3, 1, 0F); // Box 659
		bodyModel[65].setRotationPoint(18.5F, 0.25F, -9F);

		bodyModel[66].addShapeBox(0F, 0F, 0F, 1, 4, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0.5F, 0F); // Box 660
		bodyModel[66].setRotationPoint(17.5F, 0.25F, -9F);

		bodyModel[67].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 661
		bodyModel[67].setRotationPoint(35.5F, 0.25F, 8F);

		bodyModel[68].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 662
		bodyModel[68].setRotationPoint(35.5F, 0.25F, -9F);

		bodyModel[69].addBox(0F, 0F, 0F, 1, 4, 6, 0F); // Box 663
		bodyModel[69].setRotationPoint(40.5F, 1.25F, -3F);

		bodyModel[70].addBox(0F, 0F, 0F, 1, 2, 6, 0F); // Box 664
		bodyModel[70].setRotationPoint(39.5F, 3.25F, -3F);

		bodyModel[71].addShapeBox(0F, 0F, 0F, 1, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // box
		bodyModel[71].setRotationPoint(41.5F, 3.5F, -0.5F);

		bodyModel[72].addBox(0F, 0F, 0F, 1, 2, 1, 0F); // box
		bodyModel[72].setRotationPoint(42.5F, 3F, -0.5F);

		bodyModel[73].addShapeBox(0F, 0F, 0F, 1, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, -1F, 0F, 0F); // box
		bodyModel[73].setRotationPoint(42.5F, 3F, 0.5F);

		bodyModel[74].addShapeBox(0F, 0F, 0F, 1, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F); // box
		bodyModel[74].setRotationPoint(44.5F, 3F, -0.5F);

		bodyModel[75].addShapeBox(0F, 0F, 0F, 1, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F); // box
		bodyModel[75].setRotationPoint(43.5F, 3F, -1.5F);

		bodyModel[76].addShapeBox(0F, 0F, 0F, 1, 2, 3, 0F,0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 670
		bodyModel[76].setRotationPoint(40.5F, 2.25F, 5F);

		bodyModel[77].addShapeBox(0F, 0F, 0F, 1, 2, 3, 0F,0F, 0F, 0F, -1F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 663
		bodyModel[77].setRotationPoint(40.5F, 2.25F, -8F);

		bodyModel[78].addBox(0F, 0F, 0F, 21, 1, 16, 0F); // Box 664
		bodyModel[78].setRotationPoint(18.5F, 1.25F, -8F);
		...
		bodyModel[79].setRotationPoint(40F, 0.5F, -8F);

		bodyModel[80].addShapeBox(0F, 0F, 0F, 2, 1, 0, 0F,-1F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F); // Box 666
		bodyModel[80].setRotationPoint(39.5F, 0.25F, 0F);

		bodyModel[81].addBox(0F, 0F, 0F, 5, 2, 6, 0F); // Box 667
		bodyModel[81].setRotationPoint(33.5F, -0.75F, -3F);

		bodyModel[82].addBox(0F, 0F, 0F, 0, 4, 1, 0F); // Box 668
		bodyModel[82].setRotationPoint(39.5F, 3.25F, 9F);

		bodyModel[83].addShapeBox(0F, 0F, 0F, 0, 5, 1, 0F,0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 669
		bodyModel[83].setRotationPoint(36.5F, 2.25F, 9F);

		bodyModel[84].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 670
		bodyModel[84].setRotationPoint(36.5F, 7.25F, 9F);

		bodyModel[85].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 671
		bodyModel[85].setRotationPoint(36.5F, 5.25F, 9F);

		bodyModel[86].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 672
		bodyModel[86].setRotationPoint(36.5F, 3.25F, 9F);

		bodyModel[87].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 673
		bodyModel[87].setRotationPoint(36.5F, 3.25F, -10F);

		bodyModel[88].addBox(0F, 0F, 0F, 0, 4, 1, 0F); // Box 674
		bodyModel[88].setRotationPoint(39.5F, 3.25F, -10F);

		bodyModel[89].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 675
		bodyModel[89].setRotationPoint(36.5F, 5.25F, -10F);

		bodyModel[90].addBox(0F, 0F, 0F, 3, 0, 1, 0F); // Box 676
		bodyModel[90].setRotationPoint(36.5F, 7.25F, -10F);

		bodyModel[91].addShapeBox(0F, 0F, 0F, 0, 5, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 677
		bodyModel[91].setRotationPoint(36.5F, 2.25F, -10F);

		bodyModel[92].addBox(0F, 0F, 0F, 4, 2, 1, 0F); // Box 678
		bodyModel[92].setRotationPoint(35.5F, 1.25F, 8F);

		bodyModel[93].addBox(0F, 0F, 0F, 4, 2, 1, 0F); // Box 679
		bodyModel[93].setRotationPoint(35.5F, 1.25F, -9F);

		bodyModel[94].addBox(0F, 0F, 0F, 0, 4, 1, 0F); // Box 680
		bodyModel[94].setRotationPoint(41.5F, 3.25F, 2F);
		bodyModel[94].rotateAngleZ = 0.17453293F;

		bodyModel[95].addShapeBox(0F, 0F, 0F, 1, 4, 11, 0F,2F, 0F, 0F, -2.75F, 0F, 0F, -0.75F, 0F, 0F, 0F, 0F, 0F, 1F, 0F, -1F, -1.75F, 0F, -1F, 0.25F, 0F, 0F, -1F, 0F, 0F); // Box 683
		bodyModel[95].setRotationPoint(42F, 5.75F, -11F);

		bodyModel[96].addShapeBox(0F, 0F, 0F, 1, 2, 8, 0F,1.85F, -0.5F, -0.5F, -2.6F, -0.5F, -0.5F, -0.75F, -0.5F, 0F, 0F, -0.5F, 0F, 2F, 0F, 0F, -2.75F, 0F, 0F, -1.3F, 0F, 0F, 0.55F, 0F, 0F); // Box 684
		bodyModel[96].setRotationPoint(42F, 3.75F, -11F);

		bodyModel[97].addShapeBox(0F, 0F, 0F, 1, 4, 11, 0F,0F, 0F, 0F, -0.75F, 0F, 0F, -2.75F, 0F, 0F, 2F, 0F, 0F, -1F, 0F, 0F, 0.25F, 0F, 0F, -1.75F, 0F, -1F, 1F, 0F, -1F); // Box 685
		bodyModel[97].setRotationPoint(42F, 5.75F, 0F);

		bodyModel[98].addShapeBox(0F, 0F, 0F, 1, 2, 8, 0F,0F, -0.5F, 0F, -0.75F, -0.5F, 0F, -2.6F, -0.5F, -0.5F, 1.85F, -0.5F, -0.5F, 0.55F, 0F, 0F, -1.3F, 0F, 0F, -2.75F, 0F, 0F, 2F, 0F, 0F); // Box 686
		bodyModel[98].setRotationPoint(42F, 3.75F, 3F);

		bodyModel[99].addShapeBox(0F, 0F, 0F, 2, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, -2F, 0F, 0F, -2F, 0.25F, 0F, 0F, 0.25F); // Box 687
		bodyModel[99].setRotationPoint(-43.5F, 6.5F, 8F);

		bodyModel[100].addShapeBox(0F, 0F, 0F, 2, 2, 1, 0F,-1F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0.25F, -1F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F); // Box 688
		bodyModel[100].setRotationPoint(-43.5F, 4.5F, 8F);

		bodyModel[101].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,1F, 0F, 0F, 1F, 0F, 0F, 1F, 0F, 0.25F, 1F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F); // Box 689
		bodyModel[101].setRotationPoint(-41.5F, 4.5F, 8F);
		...
		bodyModel[102].setRotationPoint(-42.5F, 4F, 8F);
		...
		bodyModel[104].setRotationPoint(-41.5F, 8F, 8F);
		...
		bodyModel[106].setRotationPoint(-41.5F, 5F, -10F);

		bodyModel[107].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, -1F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0.25F, 0F, -1F, 0.25F); // Box 692
		bodyModel[107].setRotationPoint(-39.5F, 6.5F, 8F);

		bodyModel[108].addShapeBox(0F, 0F, 0F, 2, 2, 1, 0F,0F, -1F, 0F, -1F, 0F, 0F, -1F, 0F, 0.25F, 0F, -1F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F); // Box 693
		bodyModel[108].setRotationPoint(-39.5F, 4.5F, 8F);
		...
		bodyModel[109].setRotationPoint(-39.5F, 4F, 8F);

		bodyModel[110].addShapeBox(0F, 0F, 0F, 2, 2, 1, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, -1F); // Box 695
		bodyModel[110].setRotationPoint(-45.5F, 6.5F, 8F);

		bodyModel[111].addBox(0F, 0F, 0F, 1, 2, 16, 0F); // Box 696
		bodyModel[111].setRotationPoint(-45.5F, 6.5F, -8F);

		bodyModel[112].addShapeBox(0F, 0F, 0F, 3, 2, 1, 0F,0F, 0F, 0F, 0F, -1F, 0F, 0F, -1F, 0.25F, 0F, 0F, 0.25F, 0F, -0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, -0.5F, 0.25F); // Box 698
		bodyModel[112].setRotationPoint(-37.5F, 6.5F, 8F);

		bodyModel[113].addBox(0F, 0F, 0F, 1, 1, 16, 0F); // Box 699
		bodyModel[113].setRotationPoint(-35.5F, 7.5F, -8F);

		bodyModel[114].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 700
		bodyModel[114].setRotationPoint(-38.5F, 2.25F, 8F);

		bodyModel[115].addBox(0F, 0F, 0F, 1, 5, 2, 0F); // Box 701
		bodyModel[115].setRotationPoint(-43.5F, 2.25F, 7F);

		bodyModel[116].addShapeBox(0F, 0F, 0F, 4, 1, 1, 0F,-0.25F, 0F, 0F, -0.25F, 0F, 0F, -0.25F, 0F, 0.25F, -0.25F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F); // Box 702
		bodyModel[116].setRotationPoint(-42.5F, 3.5F, 8F);

		bodyModel[117].addBox(0F, 0F, 0F, 4, 0, 2, 0F); // Box 703
		bodyModel[117].setRotationPoint(-35F, 7.75F, 7F);

		bodyModel[118].addBox(0F, 0F, 0F, 1, 1, 3, 0F); // Box 704
		bodyModel[118].setRotationPoint(-33.5F, 0.25F, 7F);

		bodyModel[119].addBox(0F, -1F, -1F, 4, 2, 2, 0F); // Box 705
		bodyModel[119].setRotationPoint(-37.5F, 0.75F, 9.5F);
		bodyModel[119].rotateAngleX = -0.78539816F;

		bodyModel[120].addBox(0F, 0F, 0F, 1, 1, 3, 0F); // Box 706
		bodyModel[120].setRotationPoint(-38.5F, 0.25F, 7F);

		bodyModel[121].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 160
		bodyModel[121].setRotationPoint(9F, -1.75F, -9F);

		bodyModel[122].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F); // Box 161
		bodyModel[122].setRotationPoint(5F, -1.75F, -9F);

		bodyModel[123].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 162
		bodyModel[123].setRotationPoint(10F, -1.75F, -9F);

		bodyModel[124].addShapeBox(0F, 0F, 0F, 1, 1, 2, 0F,0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 164
		bodyModel[124].setRotationPoint(13.5F, 2.25F, -9F);

		bodyModel[125].addBox(0F, 0F, 0F, 6, 1, 2, 0F); // Box 165
		bodyModel[125].setRotationPoint(6.5F, 6.25F, -9F);
		...
		bodyModel[126].setRotationPoint(7F, 2.25F, -9F);

		bodyModel[127].addShapeBox(0F, 0F, 0F, 14, 1, 2, 0F,0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F); // Box 167
		bodyModel[127].setRotationPoint(-7.25F, 5.25F, -9F);

		bodyModel[128].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 168
		bodyModel[128].setRotationPoint(2F, 2.25F, -9F);

		bodyModel[129].addBox(0F, 0F, 0F, 4, 2, 1, 0F); // Box 169
		bodyModel[129].setRotationPoint(-2F, 2.75F, -9F);

		bodyModel[130].addBox(0F, 0F, 0F, 4, 1, 3, 0F); // Box 170
		bodyModel[130].setRotationPoint(-2F, 3.25F, -10F);

		bodyModel[131].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 171
		bodyModel[131].setRotationPoint(-3F, 2.25F, -9F);

		bodyModel[132].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 173
		bodyModel[132].setRotationPoint(1F, 7.25F, -9F);

		bodyModel[133].addBox(0F, 0F, 0F, 3, 2, 2, 0F); // Box 174
		bodyModel[133].setRotationPoint(-2F, 7.25F, -9F);

		bodyModel[134].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F); // Box 175
		bodyModel[134].setRotationPoint(-6F, 7.25F, -9F);
		...
		bodyModel[135].setRotationPoint(-2F, 6.25F, -9F);

		bodyModel[136].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 178
		bodyModel[136].setRotationPoint(-10F, -1.75F, -9F);

		bodyModel[137].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 179
		bodyModel[137].setRotationPoint(-11F, -1.75F, -9F);

		bodyModel[138].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F); // Box 180
		bodyModel[138].setRotationPoint(-15F, -1.75F, -9F);
		...
		bodyModel[139].setRotationPoint(-9F, 2.25F, -9F);
		...
		bodyModel[140].setRotationPoint(-13F, 2.25F, -9F);

		bodyModel[141].addBox(0F, 0F, 0F, 6, 1, 2, 0F); // Box 183
		bodyModel[141].setRotationPoint(-13.5F, 6.25F, -9F);

		bodyModel[142].addShapeBox(0F, 0F, 0F, 10, 1, 2, 0F,0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F, 0.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.5F, 0F, 0F); // Box 184
		bodyModel[142].setRotationPoint(-23.25F, 5.25F, -9F);
		...
		bodyModel[143].setRotationPoint(-19F, 3.25F, -9F);

		bodyModel[144].addShapeBox(0F, 0F, 0F, 3, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 186
		bodyModel[144].setRotationPoint(-18F, 2.75F, -9F);

		bodyModel[145].addShapeBox(0F, 0F, 0F, 3, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F); // Box 187
		bodyModel[145].setRotationPoint(-22F, 2.75F, -9F);
		...
		bodyModel[146].setRotationPoint(-19F, 1.75F, -9F);
		...
		bodyModel[147].setRotationPoint(-20F, -0.25F, -9F);

		bodyModel[148].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F); // Box 191
		bodyModel[148].setRotationPoint(-26F, -1.75F, -9F);

		bodyModel[149].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 192
		bodyModel[149].setRotationPoint(-27F, -1.75F, -9F);

		bodyModel[150].addShapeBox(0F, 0F, 0F, 4, 2, 2, 0F,0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1.5F, 0F); // Box 193
		bodyModel[150].setRotationPoint(-31F, -1.75F, -9F);

		bodyModel[151].addBox(0F, 0F, 0F, 1, 1, 3, 0F); // Box 195
		bodyModel[151].setRotationPoint(-33.5F, 0.25F, -10F);

		bodyModel[152].addBox(0F, -1F, -1F, 4, 2, 2, 0F); // Box 196
		bodyModel[152].setRotationPoint(-37.5F, 0.75F, -9.5F);
		bodyModel[152].rotateAngleX = -0.78539816F;

		bodyModel[153].addBox(0F, 0F, 0F, 1, 1, 3, 0F); // Box 197
		bodyModel[153].setRotationPoint(-38.5F, 0.25F, -10F);

		bodyModel[154].addBox(0F, 0F, 0F, 1, 5, 1, 0F); // Box 198
		bodyModel[154].setRotationPoint(-38.5F, 2.25F, -9F);

		bodyModel[155].addShapeBox(0F, 0F, 0F, 3, 2, 1, 0F,0F, 0F, 0.25F, 0F, -1F, 0.25F, 0F, -1F, 0F, 0F, 0F, 0F, 0F, -0.5F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, -0.5F, 0F); // Box 199
		bodyModel[155].setRotationPoint(-37.5F, 6.5F, -9F);

		bodyModel[156].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0.25F, 0F, 0.5F, 0.25F, 0F, 0.5F, 0F, 0F, -1F, 0F); // Box 200
		bodyModel[156].setRotationPoint(-39.5F, 6.5F, -9F);

		bodyModel[157].addShapeBox(0F, 0F, 0F, 2, 2, 1, 0F,0F, -1F, 0.25F, -1F, 0F, 0.25F, -1F, 0F, 0F, 0F, -1F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 201
		bodyModel[157].setRotationPoint(-39.5F, 4.5F, -9F);

		bodyModel[158].addShapeBox(0F, 0F, 0F, 4, 1, 1, 0F,-0.25F, 0F, 0.25F, -0.25F, 0F, 0.25F, -0.25F, 0F, 0F, -0.25F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 202
		bodyModel[158].setRotationPoint(-42.5F, 3.5F, -9F);

		bodyModel[159].addShapeBox(0F, 0F, 0F, 2, 1, 1, 0F,1F, 0F, 0.25F, 1F, 0F, 0.25F, 1F, 0F, 0F, 1F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 203
		bodyModel[159].setRotationPoint(-41.5F, 4.5F, -9F);

		bodyModel[160].addShapeBox(0F, 0F, 0F, 2, 2, 1, 0F,-1F, 0F, 0.25F, 0F, -1F, 0.25F, 0F, -1F, 0F, -1F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 204
		bodyModel[160].setRotationPoint(-43.5F, 4.5F, -9F);

		bodyModel[161].addShapeBox(0F, 0F, 0F, 2, 2, 1, 0F,0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, -2F, 0.25F, 0F, -2F, 0F, 0F, 0F, 0F); // Box 205
		bodyModel[161].setRotationPoint(-43.5F, 6.5F, -9F);

		bodyModel[162].addShapeBox(0F, 0F, 0F, 2, 2, 1, 0F,0F, 0F, -1F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, -1F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F); // Box 206
		bodyModel[162].setRotationPoint(-45.5F, 6.5F, -9F);

		bodyModel[163].addBox(0F, 0F, 0F, 4, 0, 2, 0F); // Box 207
		bodyModel[163].setRotationPoint(-35F, 7.75F, -9F);

		bodyModel[164].addBox(0F, 0F, 0F, 1, 3, 2, 0F); // Box 208
		bodyModel[164].setRotationPoint(-34.5F, 2.25F, -9F);
		...
		bodyModel[165].setRotationPoint(-29F, 2.25F, -9F);

		bodyModel[166].addBox(0F, 0F, 0F, 6, 1, 2, 0F); // Box 210
		bodyModel[166].setRotationPoint(-29.5F, 6.25F, -9F);
		...
		bodyModel[167].setRotationPoint(-25F, 2.25F, -9F);

		bodyModel[168].addShapeBox(0F, 0F, 0F, 8, 1, 2, 0F,0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F, 0.25F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0F, 0.25F, 0F, 0F); // Box 212
		bodyModel[168].setRotationPoint(-37.25F, 5.25F, -9F);
		...
		bodyModel[169].setRotationPoint(-39.5F, 4F, -9F);
		...
		bodyModel[170].setRotationPoint(-41.5F, 8F, -9F);
		...
		bodyModel[171].setRotationPoint(-42.5F, 4F, -9F);

		bodyModel[172].addBox(0F, 0F, 0F, 1, 5, 2, 0F); // Box 216
		bodyModel[172].setRotationPoint(-43.5F, 2.25F, -9F);

		bodyModel[173].addBox(0F, 0F, 0F, 46, 4, 8, 0F); // Box 217
		bodyModel[173].setRotationPoint(-31.5F, 2F, -4F);

		bodyModel[174].addBox(0F, 0F, 0F, 4, 5, 4, 0F); // Box 218
		bodyModel[174].setRotationPoint(-2.5F, -3F, -2F);
		...
		bodyModel[175].setRotationPoint(14F, -1.75F, 6.75F);
		...
		bodyModel[176].setRotationPoint(5F, -1.75F, 6.75F);
		...
		bodyModel[177].setRotationPoint(-6F, -1.75F, 6.75F);
		...
		bodyModel[178].setRotationPoint(-15F, -1.75F, 6.75F);
		...
		bodyModel[179].setRotationPoint(-22F, -1.75F, 6.75F);
		...
		bodyModel[180].setRotationPoint(-31F, -1.25F, 6.75F);
		...
		bodyModel[181].setRotationPoint(14F, -1.75F, -9.25F);
		...
		bodyModel[182].setRotationPoint(14F, -1.75F, -7.75F);
		...
		bodyModel[183].setRotationPoint(5F, -1.75F, -7.75F);
		...
		bodyModel[184].setRotationPoint(5F, -1.75F, -9.25F);
		...
		bodyModel[185].setRotationPoint(-6F, -1.75F, -7.75F);
		...
		bodyModel[186].setRotationPoint(-6F, -1.75F, -9.25F);
		...
		bodyModel[187].setRotationPoint(-15F, -1.75F, -7.75F);
		...
		bodyModel[188].setRotationPoint(-15F, -1.75F, -9.25F);
		...
		bodyModel[189].setRotationPoint(-22F, -1.75F, -7.75F);
		...
		bodyModel[190].setRotationPoint(-22F, -1.75F, -9.25F);
		...
		bodyModel[191].setRotationPoint(-31F, -1.25F, -7.75F);
		...
		bodyModel[192].setRotationPoint(-31F, -1.25F, -9.25F);

		bodyModel[193].addBox(0F, 0F, 0F, 21, 1, 16, 0F); // Box 193
		bodyModel[193].setRotationPoint(18.5F, 2.25F, -8F);

		bodyModel[194].addBox(0F, 0F, 0F, 21, 1, 8, 0F); // Box 194
		bodyModel[194].setRotationPoint(18.5F, 3.25F, -4F);
	}
}