...
package wwcp.client.render.rollingstock.bogies.AmericanTrucks; //Path where the model is located


import tmt.ModelConverter;
import tmt.ModelRendererTurbo;

public class MacBogieFront extends ModelConverter //Same as Filename
{
	int textureX = 128;
	int textureY = 128;
