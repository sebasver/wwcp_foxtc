...
public class BR01FrontBogie extends ModelConverter //Same as Filename
{
	int textureX = 512;
	int textureY = 512;
	...
	private void initbodyModel_1()
	{
		...
		bodyModel[0].setRotationPoint(7.5F, 6F, 6F);
		...
		bodyModel[1].setRotationPoint(-8.5F, 4.5F, -6F);
		...
		bodyModel[2].setRotationPoint(-7.5F, 6F, 6F);
		...
		bodyModel[3].setRotationPoint(7.5F, 6F, -6F);
		...
		bodyModel[4].setRotationPoint(-7.5F, 6F, -6F);
		...
		bodyModel[5].setRotationPoint(7.5F, 6F, -6F);
		...
		bodyModel[6].setRotationPoint(-7.5F, 6F, -6F);
		...
		bodyModel[7].setRotationPoint(-1.5F, 3F, -1F);
	}
}